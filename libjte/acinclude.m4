...
dnl LIBJTE_ASSERT_VERS_LIBS is by Thomas Schmitt, libburnia project
dnl It tests whether -Wl,--version-script=... works with the compiler
AC_DEFUN([LIBJTE_ASSERT_VERS_LIBS],
[
    libburnia_save_LDFLAGS="$LDFLAGS"
    LDFLAGS="$LDFLAGS -Wl,--version-script=libjte.ver"
...
[  --enable-pkgconfig-path=DIR  Absolute path of directory for libjte-*.pc],
